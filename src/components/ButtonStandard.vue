  ...
  <div class="couche1">
   	<div class="couche2">
   		<div class="couche23">
	   		<div class="couche3">
	   			<div class="couche4">
	   				<div v-if="text == 'Update'" class="battle"><div class="rotation">&#9733;</div>{{ text }}<div class="rotation">&#9733;</div></div>
	    			<div v-else class="battle">{{ text }}</div>
...
.couche1:active,
.couche2:active {
  -webkit-box-shadow: 0px 1px 2px #301c09;
  -moz-box-shadow: 0px 1px 2px #301c09;
  box-shadow: 0px 1px 2px #301c09;
}
.couche0:active {
  margin-top: 8px;
...
.battle {
  ...
  filter: drop-shadow(0px -1px #fff) drop-shadow(0px 1px #244c70)
    drop-shadow(0px 2px #244c70);
  padding-top: 15px;
